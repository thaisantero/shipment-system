...
describe 'Usuário visualiza tabela de preços por distância de modelo de transporte' do
  it 'sendo usuário regular' do
    ...
    PriceByDistance.create!(start_range: 1, end_range: 5, price_for_km: 2.2, transport_model: tm)
    PriceByDistance.create!(start_range: 5, end_range: 10, price_for_km: 2.8, transport_model: tm)
