...
RSpec.describe ServiceOrder, type: :model do
  describe 'validação' do
    it 'presença do código gerado' do
    ...
    it 'presença do pickup_adress' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order = ServiceOrder.new(pickup_address: nil, pickup_cep: '60400455', customer:,
                                          delivery_distance: 70.5)

      expect(service_order).not_to be_valid
    end

    it 'presença do pickup_cep' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order = ServiceOrder.new(pickup_address: 'Rua Baronesa, 10', pickup_cep: nil, customer:,
                                          delivery_distance: 70.5)

      expect(service_order).not_to be_valid
    end

    it 'presença do delivery_distance' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order = ServiceOrder.new(pickup_address: 'Rua Baronesa, 10', pickup_cep: '60400455', customer:,
    ...
    it 'código é único' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order_first = ServiceOrder.create(pickup_address: 'Rua Baronesa, 10', pickup_cep: '60400455', customer:,
                                                delivery_distance: 10)
      service_order_second = ServiceOrder.new(pickup_address: 'Rua General, 20', pickup_cep: '60400855', customer:,
    ...
    it 'cep tem 8 dígitos' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order = ServiceOrder.new(pickup_address: 'Rua Baronesa, 10', pickup_cep: '604004552', customer:,
                                          delivery_distance: 10)
    ...
    it 'cep só tem números' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order = ServiceOrder.new(pickup_address: 'Rua Baronesa, 10', pickup_cep: '6040045A', customer:,
                                          delivery_distance: 10)
    ...
    it 'delivery_description obrigatório quando entrega atrasada' do
      customer = Customer.create(customer_address: 'Rua Padre Filó, 24', customer_cep: '60500344',
                                  customer_name: 'Ana Paula Silva Oliveira', customer_registration_number: '00355611224')
      service_order = ServiceOrder.new(pickup_address: 'Rua Baronesa, 10', pickup_cep: '60400454', customer:,
